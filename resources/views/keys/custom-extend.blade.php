<x-app-layout>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-bold text-2xl text-gray-800 dark:text-white">
                        {{ __('Custom Key Extension Page') }}
                    </h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ __('Choose flexible time package') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 overflow-hidden shadow-xl sm:rounded-2xl mb-8 border border-gray-100 dark:border-gray-700">
                <div class="p-8">
                    {{-- Header với icon --}}
                    ...
                    <form method="POST" action="{{ route('keys.custom-extend-confirm') }}" id="extendForm">
                        ...
                        <div class="mb-8">
                            <label for="key_code"
                                ...
                                {{ __('Key Code') }} <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                                <input type="text" id="key_code" name="key_code" value="{{ old('key_code') }}"
                                    ...
                                    placeholder="Ví dụ: PK-ABCD-1234-EFGH" list="user_keys" autocomplete="off" required>
                                {{-- Icon search --}}
                            ...
                            <div class="mt-3 flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <span>{{ __('Start typing to see your Key suggestions. The system will automatically search.') }}</span>
                            </div>
                        ...
                        <div class="mb-8">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">
                               {{ __('Choose extension package') }} <span class="text-red-500">*</span>
                            </label>
                                ...
                                @foreach($packages as $package)
                                    <label class="relative cursor-pointer group">
                                        ...
                                        <div
                                            ...
                                            @if($package->days === 30)
                                                <div
                                                    class="absolute -top-2 -right-2 bg-gradient-to-r from-orange-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg">
                                                   {{ __('HOT') }}
                                                </div>
                                            @endif
                                            ...
                                            <div
                                                class="absolute top-2 right-2 w-6 h-6 bg-indigo-600 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity duration-200 flex items-center justify-center">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <p
                                                    class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">
                                                   {{ __('days') }}
                                                </p>
                                                <div class="space-y-1">
                        ...
                        <div
                            class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-6 mb-8 text-white shadow-xl">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm opacity-90">{{ __('Current wallet balance') }}</p>
