<x-guest-layout>
    <style>
        ...
        .session-status{background:#dcfce7;border:1px solid #86efac;color:#15803d;border-radius:8px;padding:10px 14px;font-size:0.875rem;margin-bottom:20px;}
        .auth-desc{font-size:0.875rem;color:var(--nk-gray-500);margin-bottom:24px;line-height:1.6;}
