    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-4xl mx-auto space-y-10">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6">
                <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">{{ __('Search for answers') }}</h3>
                <form action="#" method="GET">
                    <div class="relative">
                        <input type="search" placeholder="{{ __('Enter keyword, e.g: create order...') }}"
            ...
            <div class="space-y-4">
                ...
                @foreach ($faqs as $faq)
                    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden">
                        <details class="group">
                            <summary
                                class="flex justify-between items-center cursor-pointer p-4 sm:p-6 list-none hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-200">
                                <span class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                                    {{ $faq['question'] }}
                                </span>
                                <span class="ml-6 flex items-center">
                                    <svg class="w-5 h-5 text-indigo-500 transform group-open:rotate-180 transition duration-200"
                            ...
                            <div
                                class="px-4 sm:px-6 pb-6 pt-0 text-gray-700 dark:text-gray-300 border-t border-gray-100 dark:border-gray-700">
                                <p>{{ $faq['answer'] }}</p>
                            </div>
                        </details>
                    </div>
                ...
                <p class="text-center pt-8 text-lg text-gray-600 dark:text-gray-400">
                    {{ __('Still need help?') }} <a href="{{ route('support.contact') }}"
                        class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">{{ __('Contact our support team') }}</a>.
                </p>
            </div>
