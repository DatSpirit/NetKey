<x-app-layout>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-2xl mx-auto">
            ...
            {{-- Form Liên hệ --}}
            <div
                class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-8 text-center space-y-4">
                ...
                <div class="flex justify-center space-x-6 text-sm font-medium">
                    <a href="mailto:support@yourdomain.com"
                        class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 flex items-center">
